...
public class NoteController {
    ...
    @PostMapping("/notes")
    public String postNote(@ModelAttribute("credentials") CredentialForm credentialForm, Model model, @ModelAttribute("note") NoteForm note, Authentication authentication) {
