...
public class CredentialController {
    ...
    public String addCredential(@ModelAttribute("credentials") CredentialForm credentialForm, @ModelAttribute("note") NoteForm note,
        ...
        Credential credential = Credential.builder()
                ...
                .decodedPassword(credentialForm.getPassword())
                .build();
