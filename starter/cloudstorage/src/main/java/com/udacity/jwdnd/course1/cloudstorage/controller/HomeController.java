...
public class HomeController {
    ...
    @GetMapping
    public String home(@ModelAttribute("note") NoteForm note, @ModelAttribute("credentials")CredentialForm credentialForm, Model model, Authentication authentication) {
